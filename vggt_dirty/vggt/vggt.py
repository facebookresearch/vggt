...
from off3d.models.vggt.utils import random_mask_single_patch_vectorized
...
class VGGT(nn.Module):
    ...
    def forward(self, batch, device=None):
        ...
        if self.training and self.mask_patch_ratio > 0:
            for _ in range(1000):
        ...
        # Pose branch
        # TODO check pose encoding conversion
        # loss = 0
